...
import frc.robot.commands.StalinsOrgan;
...
public class OI {
  ...
  public OI() {
    driverX_A. whenPressed(new StalinsOrgan(DoubleSolenoid.Value.kForward));
    driverX_B. whenPressed(new StalinsOrgan(DoubleSolenoid.Value.kReverse));
  }
